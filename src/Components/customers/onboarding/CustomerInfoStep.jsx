...
const CustomerInfoStep = ({ data = {}, onChange }) => {
      ...
      <section className="rounded-xl border border-slate-200 bg-white">
        ...
        <div className="flex items-center gap-2.5 border-b border-slate-100 px-4 py-2.5">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#EAF5EF]">
            <User size={16} className="text-[#0B5D3B]" />
          </div>
...
<FormField label="Profession" required>
  <div className="relative">
    ...
    />
          ...
          <FormField label="Own House" required>
  <div className="flex h-[38px] gap-2">

    <ChoiceButton
      label="Yes"
      active={data.ownHouse === true}
      onClick={() =>
        handleChange("ownHouse", true)
      }
    />

    <ChoiceButton
      label="No"
      active={data.ownHouse === false}
      onClick={() =>
        handleChange("ownHouse", false)
      }
    />
...
<FormField label="Group / Vehicle Type">
  <div className="relative">
    <Users
      size={15}
      className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400"
